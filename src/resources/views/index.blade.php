    ...
    <form class="form" action="/confirm" method="POST">
        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--text-2divisions">
        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--radio">
                    <input type="radio" name="gender" id="1" value="1" {{ old('gender') == '1' ? 'checked' : '' }} checked>
                    <label for="1">男性</label>
                    <input type="radio" name="gender" id="2" value="2" {{ old('gender') == '2' ? 'checked' : '' }}>
                    <label for="2">女性</label>
                    <input type="radio" name="gender" id="3" value="3" {{ old('gender') == '3' ? 'checked' : '' }}>
        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--text-3divisions">
